...
public class R8Meuserservice2KafkaResourceIT {
    ...
    @Autowired
    private R8Meuserservice2KafkaProducer producer;

    @Autowired
    private R8Meuserservice2KafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        R8Meuserservice2KafkaResource kafkaResource = new R8Meuserservice2KafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/r-8-meuserservice-2-kafka/publish?message=test"))
