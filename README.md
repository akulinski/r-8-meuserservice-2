...
```
$ docker image tag r8meuserservice2 gcr.io/r8me/r8meuserservice2
$ docker push gcr.io/r8me/r8meuserservice2
```
...
```
$ kubectl scale deployment <app-name> --replicas <replica-count> -n userr8me
```
...
```
$ kubectl set image deployment/<app-name>-app <app-name>=<new-image>  -n userr8me
```
